...
public class GraphBellmanFordAlgo {
    ...
    GraphBellmanFordAlgo(int v, int e) {
        this.edges = e;
        this.vertices = v;
        edge = new Edge[e];
        for (int i = 0; i < e; i++)
    ...
    void bellmanFord(GraphBellmanFordAlgo graphBellmanFordAlgo, int src) {
        int V = graphBellmanFordAlgo.vertices, E = graphBellmanFordAlgo.edges;
        int dist[] = new int[V];
        ...
        for (int i = 1; i < V; ++i) {
            for (int j = 0; j < E; ++j) {
                int u = graphBellmanFordAlgo.edge[j].src;
                int v = graphBellmanFordAlgo.edge[j].dest;
                int weight = graphBellmanFordAlgo.edge[j].weight;
    ...
    public static void main(String[] args) {
        ...
        GraphBellmanFordAlgo graph = new GraphBellmanFordAlgo(V, E);
